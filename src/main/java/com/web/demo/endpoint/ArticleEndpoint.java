package com.web.demo.endpoint;

import java.util.ArrayList;
import java.util.List;

import com.web.demo.models.Article;
import com.web.demo.services.IArticleService;
import com.web.demo.soap.*;
...
public class ArticleEndpoint {
    private static final String NAMESPACE_URI = "http://www.web.com/demo/soap";
    @Autowired
